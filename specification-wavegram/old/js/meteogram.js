...
Meteogram.prototype.parseYrData = function () {
    ...
    $.each(xml.forecast.tabular.time, function (i, time) {
        ...
        if (i==0) {
            console.log("KK: " + meteogram.temperatures[0]['x']);
            console.log("KK: " + meteogram.temperatures[0]['y']);
            console.log("KK: " + meteogram.temperatures[0]['to']);
            console.log("KK: " + meteogram.temperatures[0]['index']);
        }
